...
export function collectInferredTypes(parserRules: ParserRule[], datatypeRules: ParserRule[]): AstTypes {
    ...
    addSubtypes(interfaces);
    addContainerTypes(interfaces);
 ...
 * @returns Interfaces.
 */
function calculateInterfaces(alternatives: TypeAlternative[]): InterfaceType[] {
...
function addSubtypes(interfaces: InterfaceType[]) {
    for (const interfaceType of interfaces) {
 ...
 */
function addContainerTypes(interfaces: InterfaceType[]): void {
