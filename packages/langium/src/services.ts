...
import type { GoToImplementationProvider } from './lsp/goto-implementation';
...
export type LangiumLspServices = {
    ...
    GoToTypeResolver?: GoToTypeProvider
    GoToImplementationResolver?: GoToImplementationProvider
