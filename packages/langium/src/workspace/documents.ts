 ...
 * The sets of symbols are assumed to be un-ordered, and no assumptions about the order of symbols in the sets should be made.
 */
...
export class DefaultLangiumDocuments implements LangiumDocuments {
    ...
    invalidateDocument(uri: URI): LangiumDocument | undefined {
        ...
        if (langiumDoc) {
            ...
            langiumDoc.documentSymbols = undefined;
